...
// 比如goadmin -newProject helloworld，则读取model.tpl, service.tpl等
// 如果是goadmin -newModule，则读取new_model.tpl, new_service.tpl等
...
func renameProjectName() {
	...
	for _, filepath := range paths {
		...
		content := strings.Replace(string(data), "goprojects", getGoProjectName(), -1)
